...
import { HeartIcon, ChatIcon, ShareIcon, LinkIcon } from '@heroicons/react/outline'
...
const Feed = ({children, id, timestamp, blogHeader, blogBody,backgroundImage, name_slug, displayName, ...customMeta }) => {
    ...
    return (
      <main className="w-full border-2 rounded-md bg-white p-5 mb-2 hover:border-purple-800 duration-150">
        <Helmet>
          ...
          <meta
            property="og:url"
            content={`https://melbite.com${Link.asPath}`}
          />
