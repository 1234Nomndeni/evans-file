...
const SignUp = () => {
    ...
    return (
        <>
            {!user ? (
                <div className="mt-24 sm:w-3/6 md:w-3/6 md:p-5 mx-auto items-center" to="/">
                    <Helmet>
                    ...
                    <section className="border-lg md:w-4/5 mx-auto mt-5 border-2 sm:p-5 md:p-5 lg:p-6 index-50 bg-white space-y-10 ">
                        ...
                        <span onClick={googleSignIn} className="flex items-center justify-center mx-auto font-bold w-full text-yellow-600 border-2 border-gray-900 rounded-full cursor-pointer mt-4">
                            <img src={googleIcon} className="w-12" alt="" />
                            <h3 className=" ">Continue with Google </h3>
                        </span>
                        <span onClick={githubSignUp} className="flex items-center justify-center text-gray-800 p-2 mx-auto font-bold w-full border-2 border-gray-900 rounded-full cursor-pointer mt-4">
                            <img src={gitHubIcon} className="w-8" alt="" />
                            <h3 className="ml-3 ">SignUp with github </h3>
                        </span>
                        <span onClick={twitterSignUp} className="flex items-center justify-center p-2 mx-auto font-bold w-full border-2 border-gray-800 rounded-full cursor-pointer mt-4">
