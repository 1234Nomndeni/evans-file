    ...
    >
      <section className="bg mx-wd2">
        ...
        <p className="mb-4 text-gray-900">
          ...
          <span onClick={() => navigate("/signIn")} className="text-purple-900 cursor-pointer hover:text-purple-700">
            create account
          </span>
          . If you already have an account{" "}
          <span onClick={() => navigate("/new")} className="text-purple-900 hover:text-purple-700 hover:font-bold cursor-pointer">
            start writting now
          </span>{" "}
        </p>
      </section>
