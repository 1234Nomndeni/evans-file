...
//   };
  ...
  return (
    <div className="pt-24 mx-wd1 mx-auto flex justify-between pb-24 wd-screen3">
      <div className="lg:space-x-5 lg:flex lg:flex-row item-center lg:-mx-4 flex flex-col text-left lg:text-left">
        ...
        <div className="lg:space-x-5 lg:flex lg:flex-row item-center lg:-mx-4 flex flex-col-reverse text-center lg:text-left">
          <div className="w-96 flex-col items-center z-10 space-y-5 rounded-md bg-purple-500 dark:bg-slate-900 p-10">
                ...
                <PayPalButtons
                  ...
                  onApprove={(data, actions) => {
                    return actions.order.capture().then((details) => {
                      navigate("/payment-successful").then();
                    });
                  }}
                />
