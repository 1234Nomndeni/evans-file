...
const Feed = ({id, timestamp, blogHeader,name_slug,displayName,  }) => {
        ...
        <main className="w-full border-2 rounded-md bg-white p-5 mb-2 hover:border-purple-800 duration-150" >
            ...
            <section className="flex justify-between mt-4">
                ...
                <span className="flex items-center w-2/5 justify-between text-gray-400">
                    <Link to={`/${name_slug}/${id}`} className="flex items-center hover:bg-gray-200 p-2 rounded-md cursor-pointer">
                 ...
                 <Menu as="div" className="ml-3 relative">
                    <div>
                      <Menu.Button className="flex items-center hover:bg-gray-200 p-2 rounded-md cursor-pointer">
                        ...
                        <p className="hidden sm:block ml-2 text-sm text-gray-600">Share</p>
                      </Menu.Button>
                    </div>
                    <Transition
                      as={Fragment}
