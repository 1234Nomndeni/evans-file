...
const Feed = ({id, backgroundImage, timestamp, blogHeader, blogBody,currentTask, description, displayName,skills, likeCount, profilePic }) => {
        ...
        <main className="w-full border-2 rounded-md bg-white p-5 mb-2 hover:border-purple-800 duration-150">
            ...
            <section className="flex justify-between mt-4">
                ...
                <span className="flex items-center w-2/5 justify-between text-gray-400">
                    ...
                    <Link to={`/posts/${id}`} onClick={openBlog} className="flex items-center hover:bg-gray-200 p-2 rounded-md cursor-pointer">
