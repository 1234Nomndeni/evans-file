        ...
        <>
            {!user ? (
                <div className="mt-24 w-3/6 mx-auto items-center" to="/">
                    <h1 className="text-center text-gray-600 font-bold">Welcome to Evansify</h1>
                    ...
                    <section className="border-lg w-4/5 mx-auto mt-5 border-2 p-6 index-50 bg-white ">
                        ...
                        <button onClick={loginToApp} className="bg-red-500 text-white mt-8 mb-4 w-full p-3 rounded-md font-bold hover:bg-red-600"> Login  </button>

                        <button onClick={register} disabled={!email || !password} className="bg-red-500 text-white  w-full p-3 rounded-md font-bold hover:bg-red-600"> Create Account  </button>
